...
{
    public partial class PrintGeneratedFabricatorPOWithoutAmount : System.Web.UI.Page
    {
        ...
        {
            GeneratedFabricatorPOWithoutAmount reportGST = new GeneratedFabricatorPOWithoutAmount();
            ...
            if (!IsPostBack)
            {
                ...
                {
                    dttax = da.PrintGeneratedFabricatorPOWithoutAmountHead(Request.QueryString["id"].ToString());
                    reportGST.Parameters["parameter1"].Value = Request.QueryString["id"].ToString();

                    dt = da.PrintGeneratedFabricatorPOWithoutAmountChild(Request.QueryString["id"]);
                    if (dt.Rows.Count > 0)
