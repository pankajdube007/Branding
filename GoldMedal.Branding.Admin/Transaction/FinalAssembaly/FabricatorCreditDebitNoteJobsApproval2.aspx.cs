...
{
    public partial class FabricatorCreditDebitNoteJobsApproval2 : System.Web.UI.Page
    {
        ...
        private DataTable GetTable2()
        {
            ...
            dt5 = objselectall.GetFabricatorCreditDebitJobsToApprove2(dsp);
            return dt5;
        }
        ...
        protected void show2()
        {
            ...
            DataTable dt = objselectsingle.GetSingleFabricatorCreditDebitJobForApprove2(dsp);
            if (dt.Rows.Count > 0)
            {
        ...
        protected void Receive()
        {
            ...
            else
            {
                ...
                result = objSend.UpdateFabricatorCreditDebitJobApprove2(dst);
                if (result == 1)
                {
