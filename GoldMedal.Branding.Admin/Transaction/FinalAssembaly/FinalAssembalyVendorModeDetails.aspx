<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="FinalAssembalyVendorModeDetails.aspx.cs" Inherits="GoldMedal.Branding.Admin.Transaction.FinalAssembaly.FinalAssembalyVendorModeDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="wrapper row-offcanvas row-offcanvas-left">
        <div class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h2 style="text-align: center;">Final Assembaly Vendor Mode Details</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
