<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="JobCloser.aspx.cs" Inherits="GoldMedal.Branding.Admin.Transaction.FinalAssembaly.JobCloser" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="wrapper row-offcanvas row-offcanvas-left">
        <div class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h2 style="text-align: center;">Job Closer</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                        ...
                        <ContentTemplate>
                            ...
                            <dx:ASPxPageControl EnableHierarchyRecreation="False" ID="ASPxPageControl1" runat="server"
                                ...
                                <TabPages>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                             ...
                                                             <div class="col-md-3">
                                                              ...
                                                              <div class="col-md-3">
                                                                 <label>Installation Date:<strong class="redmark">*</strong></label>   
                                                                 <dx:ASPxDateEdit ID="txtInstallationDate" EditFormat="Custom" EditFormatString="dd/MM/yyyy" runat="server" 
                                                            ...
                                                            <div class="row" style="padding-left: 20px">
                                                                <div class="col-md-6 cls-buttons">
                                                                    ...
                                                                    <dx:ASPxButton ID="btnApprove" runat="server" ClientIDMode="Static" OnClick="btnapprove_Click" AutoPostBack="False"
                                                                        Text="Close" CssClass="btn btn-success btn-space" ClientInstanceName="ASPxButton2" TabIndex="6">
                                                                                ...
                                                                                <dx:ASPxGridView Settings-ShowGroupPanel="true" SettingsBehavior-AllowDragDrop="true"
                                                                                    ...
                                                                                    <Columns>
                                                                                       ...
                                                                                       <%-- <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" FieldName="assignrequestno" Caption="Assign Reqno" VisibleIndex="1">
                                                                                        ...
                                                                                        <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" Width="150px" FieldName="distcontactperson" Caption="Contact Person" VisibleIndex="6">
                                                                                            <Settings ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowInFilterControl="True" AutoFilterCondition="Contains" />
                                                                                        </dx:GridViewDataTextColumn>
                                                                                        ...
                                                                                        <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" Width="220px" FieldName="SubAddress" Caption="Retailer Address" VisibleIndex="8">
                                                                                         ...
                                                                                         <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" Width="180px" FieldName="subpname" Caption="Retailer Person Name" VisibleIndex="9">
                                                                                            <Settings ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowInFilterControl="True" AutoFilterCondition="Contains" />
                                                                                        </dx:GridViewDataTextColumn>
                                                                                        ...
                                                                                        <dx:GridViewDataDateColumn Settings-AllowDragDrop="True" Width="160px" FieldName="FinalAssemblydt" Caption="Final Assembly Date" VisibleIndex="19">
                                    ...
                                    <dx:TabPage Text="List (Without Printer And Fabricator)">
                                        <ContentCollection>
                                                                                    ...
                                                                                    <Columns>
                                                                                      ...
                                                                                      <%--  <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" FieldName="assignrequestno" Caption="Assign Reqno" VisibleIndex="1">
                                                                                        ...
                                                                                        <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" Caption="View" ReadOnly="True" VisibleIndex="21">
                                                                                            <Settings AllowDragDrop="True" />
                                                                                            <DataItemTemplate>
                                                                                                <asp:LinkButton ID="CmdEdit" EnableViewState="false" CausesValidation="False" OnClientClick="lp.Show()" runat="server" CommandArgument='<%# Eval("dsslno") %>'
                                    ...
                                    <dx:TabPage Text="List (Only Printer Location)">
                                        <ContentCollection>
