<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FabricatorReceiveJob.aspx.cs" Inherits="GoldMedal.Branding.Admin.Transaction.FinalAssembaly.FabricatorReceiveJob" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="wrapper row-offcanvas row-offcanvas-left">
        <div class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h2 style="text-align: center;">Fabricator Job Receive</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    ...
                    <asp:Label ID="lbltotalqty" Visible="false" Text="0" runat="server"></asp:Label>
                                                                            ...
                                                                            <asp:UpdatePanel ID="UpdatePanel15" runat="server">
                                                                                <ContentTemplate>
                                                                                    <%--<asp:Label ID="lblqty" runat="server" />--%>
                                                                                     <asp:TextBox ID="txtqty" onkeypress="return onlyNos(this);" runat="server" CssClass="form-control" />
                                                                                </ContentTemplate>
                                                                            </asp:UpdatePanel>
                                                                        </div>
                                                                        <div class="col-md-3">
                                                                            ...
                                                                            <asp:UpdatePanel ID="UpdatePanel36" runat="server">
                                                                                <ContentTemplate>
                                                                                    ...
                                                                                    <asp:DropDownList ID="ddlActiontobetaken"  runat="server" CssClass="form-control apto" Width="130px">
                                                                                                     
                                                                                                        <asp:ListItem Value="1">No Change</asp:ListItem>
                                                                                                        <asp:ListItem Value="2">Raise Job</asp:ListItem>
                                                     ...
                                                     <br />
                                                        ...
                                                        <br />
                                                         <div class="row">
                                                            ...
                                                            <div class="col-md-3">
                                                                 <label>Job Receive Date:<strong class="redmark">*</strong></label>   
                                                                 <dx:ASPxDateEdit ID="txtJobReceiveDate" EditFormat="Custom" EditFormatString="dd/MM/yyyy" runat="server" 
                                                                     CssClass="form-control" TabIndex="1"></dx:ASPxDateEdit>             
                                                            </div>
                                                            ...
                                                            <div class="row" style="padding-left: 20px">
                                                                <div class="col-md-6 cls-buttons">
                                                                    ...
                                                                    <dx:ASPxButton ID="btnApprove" runat="server" ClientIDMode="Static" OnClick="btnapprove_Click" AutoPostBack="False"
                                                                        Text="Receive" CssClass="btn btn-success btn-space" ClientInstanceName="ASPxButton2" TabIndex="6">
                                                                        <ClientSideEvents Click="function(s, e) { lp.Show(); ASPxCallback1.PerformCallback(); }" />
                                                                    </dx:ASPxButton>
                                                                    <dx:ASPxButton ID="btnReject" runat="server" ClientIDMode="Static" OnClick="btnReject_Click" AutoPostBack="False"
                                                                            ...
                                                                            <ContentTemplate>
                                                                                <dx:ASPxGridView Settings-ShowGroupPanel="true" SettingsBehavior-AllowDragDrop="true"
                                                                                    ...
                                                                                    <Columns>
                                                                                        ...
                                                                                        <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" FieldName="subjobtype" Caption="SubJobType" VisibleIndex="13">
                                                                                            <Settings ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowInFilterControl="True" AutoFilterCondition="Contains" />
                                                                                        </dx:GridViewDataTextColumn>
                                                                                        <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" FieldName="subsubjobtype" Caption="Material" VisibleIndex="14">
                                                                                            <Settings ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowInFilterControl="True" AutoFilterCondition="Contains" />
                                                                                        </dx:GridViewDataTextColumn>
                                                                                       ...
                                                                                       <%-- <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" FieldName="JobSendTypeName" Caption="Job Send To" VisibleIndex="15">
                                                                                        ...
                                                                                        <dx:GridViewDataDateColumn Settings-AllowDragDrop="True" Width="160px" FieldName="FabricatorSendDate" Caption="Fabricator Send Date" VisibleIndex="19">
