<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FinalAssembalyDispatchDetails.aspx.cs" Inherits="GoldMedal.Branding.Admin.Transaction.FinalAssembaly.FinalAssembalyDispatchDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="wrapper row-offcanvas row-offcanvas-left">
        <div class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h2 style="text-align: center;">Final Assembaly Dispatch</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                        ...
                        <ContentTemplate>
                            ...
                            <dx:ASPxPageControl EnableHierarchyRecreation="False" ID="ASPxPageControl1" runat="server"
                                ...
                                <TabPages>
                                    ...
                                    <%--.Start of Tab-1--%>
                                    <dx:TabPage Text="Dispatch Details">
                                        <ContentCollection>
