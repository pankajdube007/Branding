<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PrinterJobDC.aspx.cs" Inherits="GoldMedal.Branding.Admin.Transaction.PrinterDesignSubmit.PrinterJobDC" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="wrapper row-offcanvas row-offcanvas-left">
        <div class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h2 style="text-align: center;">Printer's Job DC</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                            ...
                            <dx:ASPxPageControl EnableHierarchyRecreation="False" ID="ASPxPageControl1" runat="server"
                                ...
                                <TabPages>
                                                                            ...
                                                                            <dx:GridViewDataTextColumn FixedStyle="Left" Settings-AllowDragDrop="True" Caption="Send" ReadOnly="True" VisibleIndex="0" Width="100px">
                                                                                ...
                                                                                <DataItemTemplate>
                                                                                    <dx:ASPxCheckBox runat="server" ID="gvCheck" Theme="Moderno"></dx:ASPxCheckBox>
                                                                                        ...
                                                                                        <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" FieldName="Qty" Caption="Total Qty" VisibleIndex="12">
                                                                                            <Settings ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowInFilterControl="True" AutoFilterCondition="Contains" />
                                                                                        </dx:GridViewDataTextColumn>
                                                                                         ...
                                                                                         <dx:GridViewDataDateColumn Settings-AllowDragDrop="True" Width="160px" FieldName="approvedt" Caption="Approve date" VisibleIndex="14">
                                    ...
                                    <%--.Start of Tab-3--%>
                                      ...
                                      <%--.Start of Tab-2--%>
                                    <dx:TabPage Text="View Printer DC">
                                        <ContentCollection>
