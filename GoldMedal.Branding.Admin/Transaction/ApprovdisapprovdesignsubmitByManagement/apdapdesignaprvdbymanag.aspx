<%@ Page Title="" MasterPageFile="~/Site.master" Language="C#" AutoEventWireup="true" CodeBehind="apdapdesignaprvdbymanag.aspx.cs" Inherits="GoldMedal.Branding.Admin.Transaction.ApprovdisapprovdesignsubmitByManagement.apdapdesignaprvdbymanag" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="wrapper row-offcanvas row-offcanvas-left">
        <div class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h2 style="text-align: center;">Live Product Approved By Management</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                                                                     ...
                                                                     <div class="row">
                                                                         <div class="col-md-3">
                                                                            ...
                                                                            <asp:UpdatePanel ID="UpdatePanel20" runat="server">
                                                                                <ContentTemplate>
                                                                                    <asp:RadioButtonList ID="rdlist" Enabled="false" runat="server" RepeatDirection="Horizontal">
                                                                         ...
                                                                         <div class="col-md-3">
                                                                            ...
                                                                            <asp:UpdatePanel ID="UpdatePanel29" runat="server">
                                                                                <ContentTemplate>
                                                                                    <asp:TextBox ID="txtApprovalGivenBy" Enabled="false" runat="server" ClientIDMode="Static" CssClass="form-control" MaxLength="100" TabIndex="1"></asp:TextBox>
                                                                                </ContentTemplate>
                                                                            </asp:UpdatePanel>
                                                                        </div>
                                                                         ...
                                                                         <div class="col-md-3">
                                                                            ...
                                                                            <asp:UpdatePanel ID="UpdatePanel27" runat="server">
                                                                                <ContentTemplate>
                                                                                    <asp:TextBox ID="txtMgmRemark" Enabled="false" runat="server" ClientIDMode="Static" CssClass="form-control" MaxLength="500" TabIndex="2"></asp:TextBox>
                                                                                </ContentTemplate>
                                                                            </asp:UpdatePanel>
                                                                        </div>
                                                                         ...
                                                                         <div class="col-md-3">
                                                                            <label>
                                                                                Uploaded Image(<asp:Label ID="Label2" runat="server" ForeColor="Maroon"> Size < 20MB</asp:Label>
                                                                                    ...
                                                                                    <Columns>
                                                                                       ...
                                                                                       <%-- <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" FieldName="assignrequestno" Caption="Assign Request No." VisibleIndex="1">
                                                                                        ...
                                                                                        <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" FieldName="submitby" Caption="Design Submitted By" VisibleIndex="20">
                                                                                         ...
                                                                                         <dx:GridViewDataDateColumn Settings-AllowDragDrop="True" Width="160px" FieldName="MgmApprovalDate" Caption="Live product approval date" VisibleIndex="21">
                                                                                            <PropertiesDateEdit DisplayFormatString="dd/MM/yyyy hh:mm:ss tt" DisplayFormatInEditMode="True"></PropertiesDateEdit>
                                                                                            <Settings ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowInFilterControl="True" AutoFilterCondition="Contains" />
                                                                                        </dx:GridViewDataDateColumn>
                                                                                         <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" FieldName="MgmRemark" Width="200px" Caption="Remark" VisibleIndex="22">
                                                                                            <Settings ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowInFilterControl="True" AutoFilterCondition="Contains" />
                                                                                        </dx:GridViewDataTextColumn>
                                                                                      <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" Width="160px" Caption="View Submitted Images" ReadOnly="True" VisibleIndex="23">
                                                                                            <Settings AllowDragDrop="True" />
                                                                                             <DataItemTemplate>

                                                                                                   <asp:LinkButton ID="lnkShowImg" EnableViewState="false" runat="server" OnClientClick="lp.Show()"
                                                                                                        CommandArgument='<%# Eval("designsubmitslno") %>' Text='View' 
                                                                                                        Style="text-decoration: underline;" OnCommand="lnkShowImg_Command"></asp:LinkButton>

                                                                                            </DataItemTemplate>
                                                                                        </dx:GridViewDataTextColumn>
                                                                                         <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" Caption="Accept Job" ReadOnly="True" VisibleIndex="24">
                                                                                            <Settings AllowDragDrop="True" />
                                                                                            <DataItemTemplate>
                                                                                                <asp:LinkButton ID="CmdAccept" EnableViewState="false" CausesValidation="False" runat="server" CommandArgument='<%# Eval("designsubmitslno") %>'
                                                                                ...
                                                                                <dx:ASPxGridView Settings-ShowGroupPanel="true" SettingsBehavior-AllowDragDrop="true"
                                                                                    ...
                                                                                    <Columns>
                                                                                      ...
                                                                                      <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" Width="160px" Caption="View Submitted Images" ReadOnly="True" VisibleIndex="23">
                                                                                         ...
                                                                                         <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" FieldName="liveproductjobacceptedby" Caption="Job Accepted By" VisibleIndex="24">
                                                                                            <Settings ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowInFilterControl="True" AutoFilterCondition="Contains" />
                                                                                        </dx:GridViewDataTextColumn>
                                                                                        <dx:GridViewDataDateColumn Settings-AllowDragDrop="True" Width="160px" FieldName="liveproductjobaccepteddt" Caption="Job Accepted date" VisibleIndex="25">
                                                                                            <PropertiesDateEdit DisplayFormatString="dd/MM/yyyy hh:mm:ss tt" DisplayFormatInEditMode="True"></PropertiesDateEdit>
                                                                                            <Settings ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowInFilterControl="True" AutoFilterCondition="Contains" />
                                                                                        </dx:GridViewDataDateColumn>
                                                                                       <%--<dx:GridViewDataTextColumn Settings-AllowDragDrop="True" Caption="View" ReadOnly="True" VisibleIndex="21">
                                ...
                                <asp:Repeater ID="rptImages3" runat="server" OnItemCommand="rptImages3_ItemCommand" OnItemDataBound="rptImages3_ItemDataBound">
                                    <ItemTemplate>
                                            <div id="dvImage" style="width: 150px; height: 150px; overflow: hidden; text-align: center; float: left;">
                                                ...
                                                <div style="clear: both;">
                                                    <asp:LinkButton ID="LinkButton4" EnableViewState="false" runat="server"  CommandArgument='<%# Eval("ImageName") %>'
