<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="reassigntoprinter.aspx.cs" Inherits="GoldMedal.Branding.Admin.Transaction.AssigntoPrinter.reassigntoprinter" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="wrapper row-offcanvas row-offcanvas-left">
        <div class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h2 style="text-align: center;">Reassign Send For Print</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-2">
                                                                ...
                                                                <asp:UpdatePanel ID="UpdatePanel54" runat="server">
                                                                    <ContentTemplate>
                                                                        <asp:Label ID="Currentlyassignedprinter" runat="server" />
                                                                    </ContentTemplate>
                                                                </asp:UpdatePanel>
                                                            </div>
                                                            <div class="col-md-3">
                                                            ...
                                                            <div class="row" style="padding-left: 20px">
                                                                <div class="col-md-6 cls-buttons">
                                                                    ...
                                                                    <dx:ASPxButton ID="btnApprove" runat="server" ClientIDMode="Static" OnClick="btnapprove_Click" AutoPostBack="False"
                                                                        Text="Reassign " CssClass="btn btn-success btn-space" ClientInstanceName="ASPxButton2" TabIndex="6">
                                                                        <ClientSideEvents Click="function(s, e) { lp.Show(); ASPxCallback1.PerformCallback(); }" />
                                                                    </dx:ASPxButton>
                                                                                ...
                                                                                <dx:ASPxGridView Settings-ShowGroupPanel="true" SettingsBehavior-AllowDragDrop="true"
                                                                                    ...
                                                                                    <Columns>
                                                                                        ...
                                                                                        <dx:GridViewDataTextColumn Settings-AllowDragDrop="True"  Width="150px" FieldName="FabricatorLocation" Caption="Fabricator Location" VisibleIndex="23">
                                                                                         ...
                                                                                         <dx:GridViewDataTextColumn Settings-AllowDragDrop="True"  Width="150px" FieldName="PrinterName" Caption="Currently Assined To Printer" VisibleIndex="24">
                                                                                            <Settings ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowInFilterControl="True" AutoFilterCondition="Contains" />
                                                                                        </dx:GridViewDataTextColumn>
