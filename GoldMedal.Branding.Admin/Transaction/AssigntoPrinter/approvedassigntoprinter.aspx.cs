...
{
    public partial class approvedassigntoprinter : System.Web.UI.Page
    {
...
#endregion PageEvent
        public approvedassigntoprinter()
        {
        ...
        protected void gvSizeChild_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            {
                qtydel = Convert.ToInt32(lblqty.Text) - 1;
                lblqty.Text = Convert.ToString(qtydel);
            }
            else
            {
                lblqty.Text = lbljrcqty.Text;
        ...
        protected void btnaddsize_Click(object sender, EventArgs e)
        {
            ...
            if (txtboardhight.Text != string.Empty && txtboardwidth.Text != string.Empty && txtprintheight.Text != string.Empty && txtprintwidth.Text != string.Empty)
            {
                ...
                if (matchdata == false)
                {
                   ...
                   // qty = Convert.ToInt32(lblqty.Text)+ 1;
                   // lblqty.Text = Convert.ToString(qty);
                    dts.AcceptChanges();
                    Session[ViewState["_SizePageID"].ToString() + "Size"] = dts;
                    lblqty.Text = dts.Rows.Count.ToString();
                    bindgvSizeChild();
                }
            }
            else
        ...
        protected void rdsizetype_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                lblqty.Text = gvSizeChild.Rows.Count.ToString();
            }
        ...
        private void ApprovePrintJob()
        {
            ...
            else if ((fuPrintFile.PostedFiles.Count > 0 && Request.Files[0].ContentLength > 0) || txtPrintLink.Text != "")
            {
                ...
                if(((rdsizetype.SelectedValue == "0") && (txtbwidth.Text != string.Empty && txtbheight.Text != string.Empty && txtpwidth.Text != string.Empty && txtpheight.Text != string.Empty)) 
                    || ((rdsizetype.SelectedValue == "1") && (gvSizeChild.Rows.Count > 0)))
                {
                    ...
                    if (result == 1)
                    {
                        ...
                        if (rdsizetype.SelectedValue == "0")
                        {
                            if (txtbwidth.Text != string.Empty && txtbheight.Text != string.Empty && txtpwidth.Text != string.Empty && txtpheight.Text != string.Empty)
                            {
                                ...
                                sizechild.refid = Convert.ToInt32(lbslno.Text);
                        ...
                        else if (rdsizetype.SelectedValue == "1")
                        {
                            ...
                            else
                            {
                                ...
                                foreach (GridViewRow row in gvSizeChild.Rows)
                                {
                                    ...
                                    sizechildgrid.refid = Convert.ToInt32(lbslno.Text);
        ...
        private DataTable GetTable2()
        {
            ...
            dt5 = objselectall.ApprovalDetailOfJobToPrinter(dsp);
            return dt5;
        }
        ...
        private DataTable GetTable3()
        {
            ...
            dsp.slno = Convert.ToInt32(lbslno.Text);
            dsp.userid = GoldMedal.Branding.Core.Common.ValidateDataType.GetCookieInt("userlogid");
            dt5 = da2.DetailOfApprovedDesignJobToPrinter(dsp);
            return dt5;
        }
        ...
        {
            Session[ViewState["_SizePageID"].ToString() + "Size"] = null;
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                lbljrcqty.Text = Convert.ToString(dt.Rows[0]["qty"]);
                ...
                lblApproveJobRequestRemark.Text = Convert.ToString(dt.Rows[0]["ApproveJobRequestRemark"]);
                lblDesignerRemarks.Text = Convert.ToString(dt.Rows[0]["DesignerRemarks"]);
        ...
        protected void DataInsert()
        {
            ...
            else
            {
                ...
                else if (hfAllowSubmit.Value.ToString() == "0")
                {
                        ...
                        if (result != -1)
                        {
                            ...
                            if (result != -1 && result3 != -1)
                            {
                                ...
                                else
                                {
                                    ...
                                    result = objinsert2.AssignPrinterInsertMethod(dst2, out string PrEmail, out string PrMobile);
