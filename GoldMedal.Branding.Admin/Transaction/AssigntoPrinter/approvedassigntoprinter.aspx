<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="approvedassigntoprinter.aspx.cs" Inherits="GoldMedal.Branding.Admin.Transaction.AssigntoPrinter.approvedassigntoprinter" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="wrapper row-offcanvas row-offcanvas-left">
        <div class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h2 style="text-align: center;">Approve Send For Print</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    ...
                    <asp:UpdatePanel runat="server">
                        <ContentTemplate>
                             ...
                             <asp:Label ID="lbljrcqty" Visible="false" Text="0" runat="server"></asp:Label>
                            ...
                            <dx:ASPxPageControl EnableHierarchyRecreation="False" ID="ASPxPageControl1" runat="server"
                                ...
                                <TabPages>
                                                ...
                                                <div class="row ">
                                                    ...
                                                    <div class="col-md-12">
                                                                ...
                                                                <ContentTemplate>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-3">
                                                                            ...
                                                                            <asp:TextBox ID="txtbheight" onkeypress="return onlyNos(this);" OnTextChanged="txtbheightwidth_TextChanged" AutoPostBack="true" runat="server" CssClass="form-control" />
                                                                        </div>
                                                                        <div class="col-md-3">
                                                                            <label>
                                                                                Board Width:</label>
                                                                            <asp:TextBox ID="txtbwidth" onkeypress="return onlyNos(this);" OnTextChanged="txtbheightwidth_TextChanged" AutoPostBack="true" runat="server" CssClass="form-control" />
                                                                        </div>

                                                                        <div class="col-md-3">
                                                                            <label>
                                                                                Print Height:</label>
                                                                            <asp:TextBox ID="txtpheight" onkeypress="return onlyNos(this);" OnTextChanged="txtHeightWidth_TextChanged" AutoPostBack="true" runat="server" CssClass="form-control" />
                                                                        </div>
                                                                        <div class="col-md-3">
                                                                            <label>
                                                                                Print Width:</label>
                                                                            <asp:TextBox ID="txtpwidth" onkeypress="return onlyNos(this);" OnTextChanged="txtHeightWidth_TextChanged" AutoPostBack="true" runat="server" CssClass="form-control" />
                                                                        </div>
                                                                    ...
                                                                    <div class="row justify-content-center">
                                                                        ...
                                                                        <div class="col-md-3">
                                                                            <label>
                                                                                Approve Job Request Remark:</label>
                                                                            <asp:Label ID="lblApproveJobRequestRemark" runat="server" />
                                                                        </div>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-3">
                                                                            ...
                                                                            <asp:UpdatePanel ID="UpdatePanel33" runat="server">
                                                                                <ContentTemplate>
                                                                                    <asp:TextBox ID="txtprintheight" onkeypress="return onlyNos(this);" runat="server" CssClass="form-control" />
                                                                                </ContentTemplate>
                                                                            </asp:UpdatePanel>
                                                                        </div>
                                                                        <div class="col-md-3">
                                                                            ...
                                                                            <asp:UpdatePanel ID="UpdatePanel34" runat="server">
                                                                                <ContentTemplate>
                                                                                    <asp:TextBox ID="txtprintwidth" onkeypress="return onlyNos(this);" runat="server" CssClass="form-control" />
                                                                                </ContentTemplate>
                                                                            </asp:UpdatePanel>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-3">
                                                                         ...
                                                                         <div class="col-md-3">
                                                                            <label>
                                                                                Designer Remarks:</label>
                                                                            <asp:Label ID="lblDesignerRemarks" runat="server" />
                                                                        </div>
                                                        ...
                                                        <div class="row">
                                                                        <div class="col-md-3">
                                                                            <label>
                                                                                Print File(<asp:Label ID="Label3" runat="server" ForeColor="Maroon"> Size < 30MB</asp:Label>
                                                                        ):</label>
                                                                        ...
                                                                        <asp:GridView runat="server" ID="gvPrinter" AutoGenerateColumns="false" EmptyDataText="No Records Found.">
                                                                            <Columns>
                                                                                <asp:TemplateField HeaderText="Sr No." ItemStyle-Width="100">
                                                                                    <ItemTemplate>
                                                                                        <asp:Label ID="Label5" Text='<%# Container.DataItemIndex + 1 %>' runat="server" />
                                                                    ...
                                                                    <ContentTemplate>
                                                                        ...
                                                                        <asp:GridView runat="server" ID="gvfabdetail" AutoGenerateColumns="false" EmptyDataText="No Records Found.">
                                                                            <Columns>
                                                                                ...
                                                                                <asp:TemplateField HeaderText="Sr No." ItemStyle-Width="100">
                                                                                    <ItemTemplate>
                                                                                        <asp:Label ID="Label7" Text='<%# Container.DataItemIndex + 1 %>' runat="server" />
                                                                                        <asp:HiddenField ID="HiddenField1" Value='<%#Eval("slno") %>' runat="server" />
                                                                                        <asp:HiddenField ID="HiddenField2" Value='<%#Eval("MaterialID") %>' runat="server" />
                                                                                        <asp:HiddenField ID="HiddenField3" Value='<%#Eval("FabricatorID") %>' runat="server" />
                                                                                        <asp:HiddenField ID="HiddenField4" Value='<%#Eval("UnitID") %>' runat="server" />
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>
                                                        ...
                                                        <ContentTemplate>
                                                            <div class="row" style="padding-left: 20px">
                                                                <div class="col-md-6 cls-buttons">
                                                                    ...
                                                                    <dx:ASPxButton ID="btnApprove" runat="server" Visible="false" ClientIDMode="Static" OnClick="btnapprove_Click" AutoPostBack="False"
                                                                            ...
                                                                            <ContentTemplate>
                                                                                <dx:ASPxGridView Settings-ShowGroupPanel="true" SettingsBehavior-AllowDragDrop="true"
                                                                                    ...
                                                                                    <Columns>
                                                                                        ...
                                                                                        <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" FieldName="Quantity" Caption="Qty" VisibleIndex="19">
                                                                                            <Settings ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowInFilterControl="True" AutoFilterCondition="Contains" />
                                                                                        </dx:GridViewDataTextColumn>
                                                                                      ...
                                                                                      <dx:GridViewDataDateColumn Settings-AllowDragDrop="True" Width="160px" FieldName="PartyApprovalStatusUpdatedt" Caption="Dealer Approval Date" VisibleIndex="21">
                                                                                            <PropertiesDateEdit DisplayFormatString="dd/MM/yyyy hh:mm:ss tt" DisplayFormatInEditMode="True"></PropertiesDateEdit>
                                                                                            <Settings ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowInFilterControl="True" AutoFilterCondition="Contains" />
                                                                                        </dx:GridViewDataDateColumn>
                                                                                        <dx:GridViewDataDateColumn Settings-AllowDragDrop="True" Width="160px" FieldName="approve2dt" Caption="Design Approve Date" VisibleIndex="22">
                                                                                            <PropertiesDateEdit DisplayFormatString="dd/MM/yyyy hh:mm:ss tt" DisplayFormatInEditMode="True"></PropertiesDateEdit>
                                                                                            <Settings ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowInFilterControl="True" AutoFilterCondition="Contains" />
                                                                                        </dx:GridViewDataDateColumn>
                                                                                        <dx:GridViewDataTextColumn Settings-AllowDragDrop="True"  Width="150px" FieldName="PrintLocation" Caption="Print Location" VisibleIndex="23">
                                                                                            <Settings ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowInFilterControl="True" AutoFilterCondition="Contains" />
                                                                                        </dx:GridViewDataTextColumn>
                                                                                        <dx:GridViewDataTextColumn Settings-AllowDragDrop="True"  Width="150px" FieldName="FabricatorLocation" Caption="Fabricator Location" VisibleIndex="24">
                                                                                            <Settings ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowInFilterControl="True" AutoFilterCondition="Contains" />
                                                                                        </dx:GridViewDataTextColumn>
                                    ...
                                    <%--.Start of Tab-3--%>
                                     <dx:TabPage Text="Print Job Approved List" Visible="false">
                                        <ContentCollection>
                                                                                ...
                                                                                <dx:ASPxGridView Settings-ShowGroupPanel="true" SettingsBehavior-AllowDragDrop="true"
                                                                                    ...
                                                                                    <Columns>
                                                                                        ...
                                                                                        <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" Caption="View" ReadOnly="True" VisibleIndex="21">
                                                                                            <Settings AllowDragDrop="True" />
                                                                                            <DataItemTemplate>
                                                                                                <asp:LinkButton ID="LinkButton1" OnClientClick="lp.Show()" EnableViewState="false" CausesValidation="False" runat="server" CommandArgument='<%# Eval("designsubmitslno") %>'
                                                                                                    Text='View' OnCommand="CmdEdit_Command"></asp:LinkButton>
                                                                                            </DataItemTemplate>
                                                                                        </dx:GridViewDataTextColumn>
                                                                                    </Columns>
