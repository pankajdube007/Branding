...
{
    public partial class approveprinterwork : System.Web.UI.Page
    {
        ...
        {
            ASPxGridView2.DataSource = GetApprovedJobsByPrinter();
        }
        ...
        private DataTable GetTable2()
        {
            ...
            dt5 = objselectall.DetailOfJobDoneByPrinterForApproval(dsp);
            return dt5;
        }

        private DataTable GetApprovedJobsByPrinter()
        {
            DataTable dt5 = new DataTable();
            Data.AssigntoPrinter.AssigntoPrinter.AssigntoPrinterProperty dsp = new Data.AssigntoPrinter.AssigntoPrinter.AssigntoPrinterProperty();
            dsp.userid = GoldMedal.Branding.Core.Common.ValidateDataType.GetCookieInt("userlogid");
            Core.AssigntoPrinter.Assigntoprinter objselectall = new Core.AssigntoPrinter.Assigntoprinter();
            dt5 = objselectall.AllApprovedJobsOfPrinter(dsp);
            return dt5;
        }
        ...
        protected void show2()
        {
            ...
            DataTable dt = objselectsingle.DetailOfJobDoneByPrinterForApproval(dtsingle);
            if (dt.Rows.Count > 0)
            {
        ...
        protected void DataInsert()
        {
            ...
            {
                Data.AssigntoPrinter.AssigntoPrinter.AssigntoPrinterProperty dst = new Data.AssigntoPrinter.AssigntoPrinter.AssigntoPrinterProperty();
                ...
                result = objinsert.ApproveDesignSubmitByPrinterMethod(dst);
                if (result == 1)
                {
