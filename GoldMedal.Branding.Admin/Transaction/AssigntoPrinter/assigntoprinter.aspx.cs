...
{
    public partial class assigntoprinter : System.Web.UI.Page
    {
        ...
        protected void show2()
        {
            ...
            DataTable dt = objselectsingle.DetailOfJobToPrinter(dtsingle);
            if (dt.Rows.Count > 0)
            {
