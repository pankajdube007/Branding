...
{
    public partial class WallsizeJobsApproval : System.Web.UI.Page
    {
        ...
        private DataTable GetTable2()
        {
            ...
            dt4 = objselectall.GetAllDesignSubmitWallSizeJobsByUserforapprovel(dsp);
            return dt4;
        }
        ...
        protected void show2()
        {
            ...
            DataTable dt = objselectsingle.GetDetailOfDesignSubmitWallSizeByUser(dtsingle);
            if (dt.Rows.Count > 0)
            {
        ...
        private void Approve()
        {
            ...
            else
            {
                ...
                result = objinsertAssignJob.ApproveWallSizeJobInsertMethod(ApproveDst);
                if (result == "-1")
                {
