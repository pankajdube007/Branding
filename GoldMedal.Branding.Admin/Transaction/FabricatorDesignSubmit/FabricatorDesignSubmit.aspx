<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="FabricatorDesignSubmit.aspx.cs" Inherits="GoldMedal.Branding.Admin.Transaction.FabricatorDesignSubmit.FabricatorDesignSubmit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="wrapper row-offcanvas row-offcanvas-left">
        <div class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h2 style="text-align: center;">FABRICATOR's Job</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                                    ...
                                    <dx:TabPage Text="View">
                                        <ContentCollection>
                                            <dx:ContentControl ID="ContentControl1" runat="server">
                                              ...
                                              <div id="fabricatordetails" runat="server">
                                                   <div class="row">
                                                            <div class="cls-sub-topic">
                                                                <i aria-hidden="true" class="fa fa-tasks"></i>
                                                   ...
                                                   <div class="row">
                                                     ...
                                                     <div class="col-md-3">
                                                                            <label>
                                                                                Upload :<strong class="redmark">*(Size < 20MB)</strong></label>
                                                                           ...
                                                                           <div class="col-md-3">
                                                                            <label>Fabricator's File Link:</label>
                                              ...
                                              <br />
                                                    ...
                                                    <div class="col-md-12">
                                                        <asp:Button ID="btnShowPopup56" runat="server" Style="display: none" />
                                                    </div>
