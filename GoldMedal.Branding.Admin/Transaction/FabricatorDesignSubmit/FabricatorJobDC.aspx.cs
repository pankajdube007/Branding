...
{
    public partial class FabricatorJobDC : System.Web.UI.Page
    {
        ...
        /// <summary>
        /// Show the image which are added  by the Fabricator.
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        protected void show2()
        {
            ...
            if (dt.Rows.Count > 0)
            {
              ...
              //  lblFabricatorid.Text = Convert.ToString(dt.Rows[0]["Fabricatorslno"]);
              ...
              //  lblFabricator.Text = Convert.ToString(dt.Rows[0]["Fabricatorname"]);
                lblpriemail.Text = Convert.ToString(dt.Rows[0]["Fabricatoremail"]);
                lblpricontect.Text = Convert.ToString(dt.Rows[0]["Fabricatorcontact"]);
                lblprimobile.Text = Convert.ToString(dt.Rows[0]["Fabricatormobile"]);
        ...
        /// <summary>
        /// Load the material list for the perticular Fabricator
        /// </summary>
        ...
        private bool ISFabricatorPOGenerated(string AllSlno)
        {
            bool result = false;
            int getresult = 0;
            ...
            getresult = objselectsingle.IsFabricatorPoGenerated(dsp);
            if (getresult == 1)
            {
                result = true;
            }
        ...
        protected void Send()
        {
            ...
            else
            {
                ...
                //}
                else if (!ISFabricatorPOGenerated(lbmultipleslno.Text))
                {
                ...
                else
                {
                    for (int i = 0; i < ASPxGridView1.VisibleRowCount; i++)
                    {
                        ...
                        if (chk != null)
                        {
                            ...
                            if (chk.Checked == true)
                            {
                                ...
                                Data.DesignSubmit.DesignSubmit.FabricatorJobDCSend dst1 = new Data.DesignSubmit.DesignSubmit.FabricatorJobDCSend();
                                dst1.slno = Slno;
                                dst1.QtySentByFabricator = Convert.ToInt32(SendingQty.Text);
                                Core.FabricatorDesignSubmit.FabricatorDesignSubmit objSend1 = new Core.FabricatorDesignSubmit.FabricatorDesignSubmit();
                                result1 = objSend1.UpdateSentQtybyFabricatorMethod(dst1);
                    ...
                    result = objSend.JobSendByFabricatorMethod(dst);
                    if (result == 1)
                    {
        ...
        protected void clean()
        {
           ...
           // lblFabricatorid.Text = "0";
            ...
            lbslno.Text = "0";
          //  lblFabricator.Text = string.Empty;
