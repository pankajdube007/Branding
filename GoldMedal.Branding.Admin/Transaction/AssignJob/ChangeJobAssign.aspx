<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="ChangeJobAssign.aspx.cs" Inherits="GoldMedal.Branding.Admin.Transaction.AssignJob.ChangeJobAssign" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="wrapper row-offcanvas row-offcanvas-left">
        <div class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h2 style="text-align: center;">Change Assign Job</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <asp:GridView runat="server" Width="100%" ID="gvDetails" HeaderStyle-Height="30px" EmptyDataText="" 
                                                                        AllowPaging="false" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true"
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Currently Assign To">
                                                                                <ItemTemplate>
                                                                                    <asp:Label ID="lblAssignedto" runat="server" Text='<%# Eval("OldAssignto") %>'/>
                                                                                </ItemTemplate>
                                                                            </asp:TemplateField>
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Reopen" Visible="false">
                                                                                 <ItemTemplate>
                                                                                    ...
                                                                                    <Columns>
                                                                                        ...
                                                                                        <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" FieldName="GivenByName" Caption="Given By" VisibleIndex="16">
                                                                                         ...
                                                                                         <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" FieldName="submittedby" Caption="Submitted By" VisibleIndex="17">
                                                                                          ...
                                                                                          <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" FieldName="approvedby" Caption="Approved By" VisibleIndex="18">
                                                                                            <Settings ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowInFilterControl="True" AutoFilterCondition="Contains" />
                                                                                        </dx:GridViewDataTextColumn>
                                                                                        ...
                                                                                        <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" Caption="Visiting Card Image" ReadOnly="True" VisibleIndex="19">
                                                                                          ...
                                                                                          <dx:GridViewDataDateColumn Settings-AllowDragDrop="True" Width="160px" FieldName="RequestDate" Caption="Request Date" VisibleIndex="20">
                                                                                            <PropertiesDateEdit DisplayFormatString="dd/MM/yyyy hh:mm:ss tt" DisplayFormatInEditMode="True"></PropertiesDateEdit>
                                                                                            <Settings ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowInFilterControl="True" AutoFilterCondition="Contains" />
                                                                                        </dx:GridViewDataDateColumn>

                                                                                         <dx:GridViewDataDateColumn Settings-AllowDragDrop="True" Width="160px" FieldName="approve2dt" Caption="Approve Date" VisibleIndex="21">
                                                                                            <PropertiesDateEdit DisplayFormatString="dd/MM/yyyy hh:mm:ss tt" DisplayFormatInEditMode="True"></PropertiesDateEdit>
                                                                                            <Settings ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowInFilterControl="True" AutoFilterCondition="Contains" />
                                                                                        </dx:GridViewDataDateColumn>
                                                                                        ...
                                                                                        <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" Caption="View" ReadOnly="True" VisibleIndex="23">
                                                                                            <Settings AllowDragDrop="True" />
                                                                                            <DataItemTemplate>
