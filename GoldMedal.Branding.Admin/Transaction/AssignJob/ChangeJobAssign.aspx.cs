...
{
    public partial class ChangeJobAssign : System.Web.UI.Page
    {
        #region Page Event
        ...
        protected void BindJobChild()
        {
            ...
            Core.AssignJob.AssignJob objdataHeadassign = new Core.AssignJob.AssignJob();
            DataTable dtChildassign = objdataHeadassign.JobRequestChildSelectForReAssignParticularCore(paramHeadassign);
        ...
        private DataTable GetTableHead()
        {
            ...
            DataTable dt = objdata.AllJobRequestHeadForChangeAssignDACoreuser(param);
                ...
                if (error == string.Empty)
                {
                    ...
                    foreach (GridViewRow row in gvDetails.Rows)
                    {
                        ...
                        if ((!string.IsNullOrEmpty(lblwidth)) && (selectedAssignto != "0"))
                        {
                            ...
                            result = objinsertAssignJob.ChangeAssignJobInsertMethod(AssignDst);
                            if (result == 1)
                            {
