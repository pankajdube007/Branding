<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="AssignToFabricator.aspx.cs" Inherits="GoldMedal.Branding.Admin.Transaction.AssignToFabricator.AssignToFabricator" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="wrapper row-offcanvas row-offcanvas-left">
        <div class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h2 style="text-align: center;">Send To Fabricator</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    ...
                    <asp:Label ID="lbfablrequestno" Visible="false" Text="0" runat="server"></asp:Label>
                        ...
                        <ContentTemplate>
                            ...
                            <dx:ASPxPageControl EnableHierarchyRecreation="False" ID="ASPxPageControl1" runat="server"
                                ...
                                <TabPages>
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-3" style="display:none;">
                                                                <label>
                                                                    File Uploaded By Printer :</label>
                                                             ...
                                                             <div class="col-md-3" style="display:none;">
                                                                            <label>
                                                                               File Link Uploaded By Printer :</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                <label>
                                                                    Fabricator:<strong class="redmark">*</strong></label>
                                                                <asp:UpdatePanel ID="UpdatePanel20" runat="server">
                                                                    <ContentTemplate>
                                                                        <dx:ASPxComboBox ID="cmbFab" ClientInstanceName="cmbFab" ClientIDMode="Static" runat="server" CssClass="form-control"
                                                                            ...
                                                                            IncrementalFilteringMode="Contains" OnSelectedIndexChanged="cmbfab_SelectedIndexChanged" AutoPostBack="True">
                                                        ...
                                                        <div class="row" style="display:none">
                                                            ...
                                                            <div class="col-md-3">
                                                                ...
                                                                <asp:UpdatePanel ID="UpdatePanel31" runat="server">
                                                                    <ContentTemplate>
                                                                        <asp:TextBox MaxLength="100" Style="resize: none" TextMode="MultiLine" ID="txtremark" ClientIDMode="Static" runat="server" TabIndex="1" CssClass="form-control"></asp:TextBox>
                                                                    </ContentTemplate>
                                                                </asp:UpdatePanel>
                                                            </div>
                                                                                ...
                                                                                <dx:ASPxGridView Settings-ShowGroupPanel="true" SettingsBehavior-AllowDragDrop="true"
                                                                                    ...
                                                                                    <Columns>
                                                                                       ...
                                                                                       <%-- <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" FieldName="assignrequestno" Caption="Assign Request No." VisibleIndex="1">
                                                                                        ...
                                                                                        <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" FieldName="distcontactperson" Caption="ContactPerson" Visible="false" VisibleIndex="6">
                                                                                            <Settings ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowInFilterControl="True" AutoFilterCondition="Contains" />
                                                                                        </dx:GridViewDataTextColumn>
                                                                                        ...
                                                                                        <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" FieldName="SubContact" Caption="Retailer Contact" Visible="false" VisibleIndex="11">
                                                                                            <Settings ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowInFilterControl="True" AutoFilterCondition="Contains" />
                                                                                        </dx:GridViewDataTextColumn>
                                                                                        ...
                                                                                        <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" FieldName="printername" Caption="Printer" VisibleIndex="17">
                                                                                            <Settings ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowInFilterControl="True" AutoFilterCondition="Contains" />
                                                                                        </dx:GridViewDataTextColumn>
                                                                                        <dx:GridViewDataDateColumn Settings-AllowDragDrop="True" Width="160px" FieldName="JobassignedtoPrinterDate" Caption="Job Assigned To Printer Date" VisibleIndex="18">
                                                                                            <PropertiesDateEdit DisplayFormatString="dd/MM/yyyy" DisplayFormatInEditMode="True"></PropertiesDateEdit>
                                                                                            <Settings ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowInFilterControl="True" AutoFilterCondition="Contains" />
                                                                                        </dx:GridViewDataDateColumn>
                                                                                         <dx:GridViewDataDateColumn Settings-AllowDragDrop="True" Width="160px" FieldName="JobreceivedfromPrinterDate" Caption="Job received from Printer Date" VisibleIndex="19">
                                                                                            <PropertiesDateEdit DisplayFormatString="dd/MM/yyyy" DisplayFormatInEditMode="True"></PropertiesDateEdit>
                                                                                            <Settings ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowInFilterControl="True" AutoFilterCondition="Contains" />
                                                                                        </dx:GridViewDataDateColumn>
                                                                                         

                                                                                        <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" Caption="View" ReadOnly="True" VisibleIndex="20">
                                                                                            <Settings AllowDragDrop="True" />
                                                                                            <DataItemTemplate>
                                                                                                <asp:LinkButton ID="CmdEdit" OnClientClick="lp.Show()" EnableViewState="false" CausesValidation="False" runat="server" CommandArgument='<%# Eval("assignprinterid") %>'
                                    ...
                                    <dx:TabPage Text="Reassign List (Assigned By Printer)">
                                        <ContentCollection>
                                                                                    ...
                                                                                    <Columns>
                                                                                      ...
                                                                                      <%--  <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" FieldName="assignrequestno" Caption="Assign Request No." VisibleIndex="1">
                                                                                        ...
                                                                                        <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" Caption="View" ReadOnly="True" VisibleIndex="21">
                                                                                            ...
                                                                                            <DataItemTemplate>
                                                                                                <asp:LinkButton ID="CmdEdit" OnClientClick="lp.Show()" EnableViewState="false" CausesValidation="False" runat="server" CommandArgument='<%# Eval("assignprinterid") %>'
                                                                                                    Text='View' OnCommand="CmdEdit2_Command"></asp:LinkButton>
                                                                                            </DataItemTemplate>
                                                                                        </dx:GridViewDataTextColumn>
                                                                                    </Columns>
                                                                                    <Settings ShowFilterRow="True" />
