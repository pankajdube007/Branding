...
namespace GoldMedal.Branding.Admin.Transaction.AssignToFabricator
{
    ...
    public partial class PrinterCreditDebitNoteJobsApproval2 : System.Web.UI.Page
    {
        ...
        private DataTable GetTable2()
        {
            ...
            dt5 = objselectall.GetPrinterCreditDebitJobsToApprove2(dsp);
            return dt5;
        }
        ...
        protected void show2()
        {
            ...
            DataTable dt = objselectsingle.GetSinglePrinterCreditDebitJobForApprove2(dsp);
            if (dt.Rows.Count > 0)
            {
        ...
        protected void Receive()
        {
            ...
            else
            {
                ...
                result = objSend.UpdatePrinterCreditDebitJobApprove2Method(dst);
                if (result == 1)
                {
