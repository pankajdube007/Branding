<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReceiveJob.aspx.cs" Inherits="GoldMedal.Branding.Admin.Transaction.AssignToFabricator.ReceiveJob" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="wrapper row-offcanvas row-offcanvas-left">
        <div class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h2 style="text-align: center;">Printer Job Receive</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                                                     ...
                                                     <br />
                                                        ...
                                                        <br />
                                                         <div class="row">
                                                            ...
                                                            <div class="col-md-3">
                                                                 <label>Job Receive/Reject Date:<strong class="redmark">*</strong></label>   
                                                                            ...
                                                                            <ContentTemplate>
                                                                                <dx:ASPxGridView Settings-ShowGroupPanel="true" SettingsBehavior-AllowDragDrop="true"
                                                                                    ...
                                                                                    <Columns>
                                                                                        ...
                                                                                        <dx:GridViewDataDateColumn Settings-AllowDragDrop="True" Width="160px" FieldName="PrinterSendDate" Caption="Printer Send Date" VisibleIndex="19">
