...
{
    public partial class PrinterCreditDebitNoteJobsApproval1 : System.Web.UI.Page
    {
        ...
        private DataTable GetTable2()
        {
            ...
            dt5 = objselectall.GetPrinterCreditDebitJobsToApprove1(dsp);
            return dt5;
        }
        ...
        protected void show2()
        {
            ...
            DataTable dt = objselectsingle.GetSinglePrinterCreditDebitJobForApprove1(dsp);
            if (dt.Rows.Count > 0)
            {
        ...
        protected void Receive()
        {
            ...
            if (lbslno.Text == "0")
            {
                ScriptManager.RegisterStartupScript(this, GetType(), "alertMessage", "showDialog('Error','Please select any one job for approval..','error',3);", true);
            }
            else
            {
                        ...
                        result = objSend.UpdatePrinterCreditDebitJobApprove1Method(dst);
                        if (result == 1)
                        {
