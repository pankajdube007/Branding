<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BillUpload.aspx.cs" Inherits="GoldMedal.Branding.Admin.Transaction.BillFillUpload.BillUpload" %>
        ...
        <div class="content" id="contactForm">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h2 style="text-align: center;">Bill Upload
                    </h2>
                </div>
            </div>
            <div class="row">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                ...
                                                                <asp:UpdatePanel ID="UpdatePanel15" runat="server">
                                                                    <ContentTemplate>
                                                                        ...
                                                                        <dx:ASPxComboBox ID="cmbBranch" ClientInstanceName="cmbcmbBranch" OnSelectedIndexChanged="cmbBranch_SelectedIndexChanged" AutoPostBack="true" ClientIDMode="Static" runat="server" CssClass="form-control"
                                                                            ...
                                                                            <ClientSideEvents ValueChanged="function(s, e) {lp.Show();ASPxCallback1.PerformCallback();}" />
                                                                        </dx:ASPxComboBox>
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                                                    <ContentTemplate>
                                                                        ...
                                                                        <dx:ASPxComboBox ID="cboType" runat="server" TabIndex="2" OnSelectedIndexChanged="cboType_SelectedIndexChanged" AutoPostBack="true" CssClass="form-control" ValueType="System.String">
                                                                            <Items>
                                                                                <dx:ListEditItem Value="1" Selected="true" Text="Printer" />
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                                                    <ContentTemplate>
                                                                        <dx:ASPxComboBox ID="cboTypeName" ClientInstanceName="cboTypeName" OnSelectedIndexChanged="cboTypeName_SelectedIndexChanged" AutoPostBack="true" ClientIDMode="Static" runat="server" CssClass="form-control"
                                                                            EnableIncrementalFiltering="True" TabIndex="3" TextFormatString="{0}-{1}"
                                                                            IsTextEditable="True" ValueType="System.String"
                                                                            IncrementalFilteringMode="Contains">
                                                                            <ClientSideEvents ValueChanged="function(s, e) {lp.Show();ASPxCallback1.PerformCallback();}" />
                                                                        </dx:ASPxComboBox>
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                                                    <ContentTemplate>
                                                                        <dx:ASPxListBox ID="cboDCNumber" runat="server" ClientInstanceName="cboDCNumber"
                                                                            Width="500px" JS-Filter="True" CssClass="form-control js-filter-class" ValueType="System.String"
                                                                            TabIndex="4" SelectionMode="CheckColumn" Theme="Glass" Height="120px" Style="overflow: hidden; padding: 0 !important; margin: 0 !important;">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <dx:ASPxButton ID="CmdSubmit" runat="server" OnClick="CmdSubmit_Click" AutoPostBack="False"
                                                                            Text="Save" CssClass="btn btn-success btn-space" ClientInstanceName="ASPxButton2" ClientIDMode="Static" TabIndex="5">
                                                                                ...
                                                                                <dx:ASPxGridView Settings-ShowGroupPanel="true" SettingsBehavior-AllowDragDrop="true"
                                                                                    ...
                                                                                    <Columns>
                                                                                        ...
                                                                                        <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" Caption="Edit" ReadOnly="True"
                                                                                            ...
                                                                                            <DataItemTemplate>
                                                                                                <asp:LinkButton ID="CmdEdit" Visible='<%#Eval("status").ToString()=="Approved"?false:true %>' OnClientClick="lp.Show()" EnableViewState="false" CausesValidation="False" runat="server" CommandArgument='<%# Eval("slno") %>'
                                                                                        ...
                                                                                        <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" Caption="Delete" ReadOnly="True"
                                                                                            ...
                                                                                            <Settings AllowDragDrop="True" />
                                                                                            <DataItemTemplate>
                                                                                                <asp:LinkButton ID="CmdDelete" Visible='<%#Eval("status").ToString()=="Approved"?false:true %>' OnClientClick="lp.Show()" EnableViewState="false" CausesValidation="False" runat="server" CommandArgument='<%# Eval("slno") %>'
