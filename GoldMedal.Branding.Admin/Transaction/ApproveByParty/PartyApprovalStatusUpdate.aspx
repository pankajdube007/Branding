<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="PartyApprovalStatusUpdate.aspx.cs" Inherits="GoldMedal.Branding.Admin.Transaction.ApproveByParty.PartyApprovalStatusUpdate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="wrapper row-offcanvas row-offcanvas-left">
        <div class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h2 style="text-align: center;">Party Approval Status Update </h2>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                            ...
                            <dx:ASPxPageControl EnableHierarchyRecreation="False" ID="ASPxPageControl1" runat="server"
                                ...
                                <TabPages>
                                    ...
                                    <dx:TabPage Text="View">
                                                                ...
                                                                <ContentTemplate>
                                                                    ...
                                                                    <br />
                                                                     <div class="row">
                                                                         ...
                                                                         <div class="col-md-3">
                                                                            <label>
                                                                                Party Approval Image :</label>
                                                                            <asp:UpdatePanel ID="UpdatePanel24" runat="server">
                                                                                <ContentTemplate>
                                                                                    <asp:LinkButton ID="partyappimg" runat="server" Text="View Image " OnClick="partyappimg_Click"></asp:LinkButton>
                                                                                </ContentTemplate>
                                                                            </asp:UpdatePanel>
                                                                        </div>
                                                            ...
                                                            <div class="row" style="padding-left: 20px">
                                                                <div class="col-md-6 cls-buttons">
                                                                    <asp:Button ID="btnOverWrite" runat="server" class="btn" Style="display: none" OnClick="btnOverWrite_Click" TabIndex="27" Text="OverWrite" />
                                                                     <dx:ASPxButton ID="btnReopen" runat="server" Visible="false" ClientIDMode="Static" OnClick="btnReopen_Click" AutoPostBack="False"
                                                                        Text="Reopen" CssClass="btn btn-success btn-space" ClientInstanceName="ASPxButton3" TabIndex="6">
                                                                    </dx:ASPxButton>
                                                                    ...
                                                                    <dx:ASPxButton ID="btnDisapprove" runat="server" Visible="false" ClientIDMode="Static" OnClick="btnDisapprove_Click" AutoPostBack="False"
                                                                    ...
                                                                    <dx:ASPxButton ID="btnCancel" runat="server" Visible="false" Text="Cancel" CssClass="btn " TabIndex="8"
                                      ...
                                      <%--.Start of Tab-3--%>
                                    <dx:TabPage Text="Approved By Party">
                                        <ContentCollection>
                                                                            ...
                                                                            <ContentTemplate>
                                                                                <dx:ASPxGridView Settings-ShowGroupPanel="true" SettingsBehavior-AllowDragDrop="true"
                                                                                    ...
                                                                                    <Columns>
                                                                                        ...
                                                                                        <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" Width="220px" FieldName="sendemail" Caption="Email Sent To" VisibleIndex="20">
                                                                                            <Settings ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowInFilterControl="True" AutoFilterCondition="Contains" />
                                                                                        </dx:GridViewDataTextColumn>
                                                                                       ...
                                                                                       <%-- <dx:GridViewDataDateColumn Settings-AllowDragDrop="True" Width="160px" FieldName="designapprovedate" Caption="Design Approve Date" VisibleIndex="20">
                                                                                            <PropertiesDateEdit DisplayFormatString="dd/MM/yyyy hh:mm:ss tt" DisplayFormatInEditMode="True"></PropertiesDateEdit>
                                                                                            <Settings ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowInFilterControl="True" AutoFilterCondition="Contains" />
                                                                                        </dx:GridViewDataDateColumn>--%>

                                                                                        <dx:GridViewDataDateColumn Settings-AllowDragDrop="True" Width="160px"  Visible="false" FieldName="isapprovepartydt" Caption="Party Disapprove Date" VisibleIndex="20">
                                                                                            <PropertiesDateEdit DisplayFormatString="dd/MM/yyyy hh:mm:ss tt" DisplayFormatInEditMode="True"></PropertiesDateEdit>
                                                                                            <Settings ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowInFilterControl="True" AutoFilterCondition="Contains" />
                                                                                        </dx:GridViewDataDateColumn>


                                                                                        <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" FieldName="PartyRemark" Visible="false" Caption="Party Remark" VisibleIndex="20">
                                                                                            <Settings ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowInFilterControl="True" AutoFilterCondition="Contains" />
                                                                                        </dx:GridViewDataTextColumn>
                                    ...
                                    <%--.Start of Tab-3--%>
                                    <dx:TabPage Text="DisApproved By Party">
                                        <ContentCollection>
                                                                                ...
                                                                                <dx:ASPxGridView Settings-ShowGroupPanel="true" SettingsBehavior-AllowDragDrop="true"
                                                                                    ...
                                                                                    <Columns>
                                                                                       ...
                                                                                       <%-- <dx:GridViewDataDateColumn Settings-AllowDragDrop="True" Width="160px" FieldName="designapprovedate" Caption="Design Approve Date" VisibleIndex="20">
                                                                                        ...
                                                                                        <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" Visible="false" FieldName="PartyRemark" Caption="Party Remark" VisibleIndex="20">
                                                                                            <Settings ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowInFilterControl="True" AutoFilterCondition="Contains" />
                                                                                        </dx:GridViewDataTextColumn>
                                                                                        ...
                                                                                        <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" Caption="View" ReadOnly="True" VisibleIndex="21">
                                                                                            ...
                                                                                            <DataItemTemplate>
                                                                                                <asp:LinkButton ID="CmdEdit" EnableViewState="false" OnClientClick="lp.Show()" CausesValidation="False" runat="server" CommandArgument='<%# Eval("designsubmitslno") %>'
                                                                                                    Text='View' OnCommand="CmdEdit3_Command"></asp:LinkButton>
                                                                                            </DataItemTemplate>
                                                                                        </dx:GridViewDataTextColumn>
     ...
     <div>
        ...
        <asp:ModalPopupExtender ID="mpeImage4" runat="server" TargetControlID="btnShowPopup3" PopupControlID="pnlpopup3"
            CancelControlID="btnCloseMPE4" BackgroundCssClass="modalBackground">
        </asp:ModalPopupExtender>
            ...
            <div class="row">
                <div class="col-lg-12">
                 <asp:UpdatePanel runat="server">
                    <ContentTemplate>
                        <div class="row" align="center">
                            <asp:Button ID="btnCloseMPE4" runat="server" Width="100" Height="30" Text="Close"  CssClass="btn btn-info btn-space" />
                        </div>
                    </ContentTemplate>
                    <Triggers>
                        <asp:PostBackTrigger ControlID="btnCloseMPE4" />
                    </Triggers>
                </asp:UpdatePanel>
                </div>
            </div>
