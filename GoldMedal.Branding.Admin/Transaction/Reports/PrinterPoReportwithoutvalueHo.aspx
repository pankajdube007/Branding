<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="PrinterPoReportwithoutvalueHo.aspx.cs" Inherits="GoldMedal.Branding.Admin.Transaction.Reports.PrinterPoReportwithoutvalueHo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="wrapper row-offcanvas row-offcanvas-left">
        <div class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h2 style="text-align: center;">Printer's Job PO Report</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
