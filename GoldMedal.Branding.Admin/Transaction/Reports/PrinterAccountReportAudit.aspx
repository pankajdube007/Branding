<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="PrinterAccountReportAudit.aspx.cs" Inherits="GoldMedal.Branding.Admin.Transaction.Reports.PrinterAccountReportAudit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="wrapper row-offcanvas row-offcanvas-left">
        <div class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h2 style="text-align: center;">Printer Account Report Audit</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
