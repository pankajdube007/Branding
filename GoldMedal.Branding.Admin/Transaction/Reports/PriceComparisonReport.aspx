<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="PriceComparisonReport.aspx.cs" Inherits="GoldMedal.Branding.Admin.Transaction.Reports.PriceComparisonReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="wrapper row-offcanvas row-offcanvas-left">
        <div class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h2 style="text-align: center;">Price Comparison Report (Fabricator)</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
