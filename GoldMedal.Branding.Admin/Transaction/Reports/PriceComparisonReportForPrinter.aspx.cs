...
{
    public partial class PriceComparisonReportForPrinter : System.Web.UI.Page
    {
        ...
        private DataTable GetTable2()
        {
            ...
            Core.Printer.Printer objsingle = new Core.Printer.Printer();
        ...
        {
            return string.Format("Pricing_Comparison_For_Printer_{0}", DateTime.Now.ToString());
        }
        #region Export
        /// <summary>
        ...
        protected void btnCsvExport_Click(object sender, EventArgs e)
        {
            ...
            ASPxPivotGridExporter1.ExportCsvToResponse("Pricing_Comparison_For_Printer_{0}", new CsvExportOptionsEx() { ExportType = ExportType.WYSIWYG });
        ...
        protected void btnXlsExport_Click(object sender, EventArgs e)
        {
            ...
            ASPxPivotGridExporter1.ExportXlsToResponse("Pricing_Comparison_For_Printer_{0}", new XlsExportOptionsEx { ExportType = ExportType.WYSIWYG });
        }
        ...
        protected void btnXlsxExport_Click(object sender, EventArgs e)
        {
            ...
            ASPxPivotGridExporter1.ExportXlsxToResponse("Pricing_Comparison_For_Printer_{0}", new XlsxExportOptionsEx { ExportType = ExportType.WYSIWYG });
        }
