...
{
    public partial class LiveProductJobStatusBranchwiseReport : System.Web.UI.Page
    {
        ...
        private DataTable GetApprovedJobs()
        {
            ...
            dt4 = objselectall.GetBranchwiseSubmitedDesignApprovedByMgm(dsp);
            return dt4;
        }
        ...
        private DataTable GetDispprovedJobs()
        {
            ...
            dt4 = objselectall.GetBranchwiseSubmitedDesignDisapprovedByMgm(dsp);
            return dt4;
        }
