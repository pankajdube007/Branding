...
namespace GoldMedal.Branding.Admin.Transaction.Reports
{
    ...
    public partial class PrinterDcReportHO : System.Web.UI.Page
    {
        ...
        private DataTable GetTable1()
        {
            ...
            dt4 = objselectall.GetPrinterDCReportHO(dsp);
            return dt4;
        }
        ...
        {
            return string.Format("PrinterDC_Report_HO_{0}", DateTime.Now.ToString());
        }
