<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="FabricatorSupplierReport.aspx.cs" Inherits="GoldMedal.Branding.Admin.Transaction.Reports.FabricatorSupplierReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="wrapper row-offcanvas row-offcanvas-left">
        <div class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h2 style="text-align: center;">Fabricator Supplier Report</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                                                                            ...
                                                                            <ContentTemplate>
                                                                                ...
                                                                                <dx:ASPxGridView Settings-ShowGroupPanel="true" SettingsBehavior-AllowDragDrop="true"
                                                                                    ...
                                                                                    <Columns>
                                                                                        ...
                                                                                        <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" FieldName="FabricatorSlno" Caption="FabricatorSlno" Visible="false" VisibleIndex="1">
