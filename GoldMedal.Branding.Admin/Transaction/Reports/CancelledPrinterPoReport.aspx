<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CancelledPrinterPoReport.aspx.cs" Inherits="GoldMedal.Branding.Admin.Transaction.Reports.CancelledPrinterPoReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="wrapper row-offcanvas row-offcanvas-left">
        <div class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h2 style="text-align: center;">Cancelled Printer Po Report</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                        ...
                        <ContentTemplate>
                            ...
                            <dx:ASPxPageControl EnableHierarchyRecreation="False" ID="ASPxPageControl1" runat="server"
                                ...
                                <TabPages>
                                      ...
                                      <%--.Start of Tab-1--%>
                                    <dx:TabPage Text="Cancelled Printer PO">
                                        <ContentCollection>
                                                                            ...
                                                                            <ContentTemplate>
                                                                                ...
                                                                                <br />
                                                                                 ...
                                                                                 <Columns>
                                                                                        ...
                                                                                        <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" FieldName="CancelDate" Caption="Cancel Date" VisibleIndex="17">
                                                                                            <Settings ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowInFilterControl="True" AutoFilterCondition="Contains" />
                                                                                        </dx:GridViewDataTextColumn>
                                                                                        <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" FieldName="CancelRemark" Caption="Cancel Remark" VisibleIndex="18">
                                                                                            <Settings ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowInFilterControl="True" AutoFilterCondition="Contains" />
                                                                                        </dx:GridViewDataTextColumn>
