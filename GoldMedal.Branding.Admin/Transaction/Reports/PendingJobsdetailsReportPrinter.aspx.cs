...
{
    public partial class PendingJobsdetailsReportPrinter : System.Web.UI.Page
    {
        ...
        private DataTable GetTable2()
        {
            ...
            dt4 = objselectall.GetPendingJobReportForPrinter(dsp);
            return dt4;
        }
        protected string GetFileName()
        {
            return string.Format("Printer_Pending_Jobs_{0}", DateTime.Now.ToString());
        }
        #region Export
        /// <summary>
