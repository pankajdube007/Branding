...
{
    public partial class FabricatorPoAgingReport : System.Web.UI.Page
    {
        ...
        private DataTable GetTable1()
        {
            ...
            DataTable dt = objselectsingle.GetFabricatorPOAgingReport(dtsingle);
        ...
        {
            return string.Format("FabricatorPO_Aging_Report_{0}", DateTime.Now.ToString());
        }
