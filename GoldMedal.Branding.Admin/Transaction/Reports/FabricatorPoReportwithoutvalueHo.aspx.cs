...
namespace GoldMedal.Branding.Admin.Transaction.Reports
{
    ...
    public partial class FabricatorPoReportwithoutvalueHo : System.Web.UI.Page
    {
        ...
        private DataTable GetTable1()
        {
            ...
            DataTable dt = objselectsingle.GetFabricatorPOwithoutValueHO(dtsingle);
        ...
        {
            return string.Format("FabricatorPO_Report_HO_{0}", DateTime.Now.ToString());
        }
