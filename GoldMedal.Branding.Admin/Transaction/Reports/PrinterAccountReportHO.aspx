<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="PrinterAccountReportHO.aspx.cs" Inherits="GoldMedal.Branding.Admin.Transaction.Reports.PrinterAccountReportHO" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="wrapper row-offcanvas row-offcanvas-left">
        <div class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h2 style="text-align: center;">Printer Account Report HO</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                        ...
                        <ContentTemplate>
                            ...
                            <dx:ASPxPageControl EnableHierarchyRecreation="False" ID="ASPxPageControl1" runat="server"
                                ...
                                <TabPages>
                                      ...
                                      <%--.Start of Tab-1--%>
                                    <dx:TabPage Text="Printer Report">
                                        <ContentCollection>
