...
{
    public partial class PrinterAccountReportHO : System.Web.UI.Page
    {
        ...
        private DataTable GetTable1()
        {
            ...
            dt4 = objselectall.GetPrinterAccountReportHO(dsp);
            return dt4;
        }
        ...
        {
            return string.Format("Printer_Account_Report_HO_{0}", DateTime.Now.ToString());
        }
