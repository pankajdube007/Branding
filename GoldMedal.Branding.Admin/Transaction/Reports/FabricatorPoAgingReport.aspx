<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="FabricatorPoAgingReport.aspx.cs" Inherits="GoldMedal.Branding.Admin.Transaction.Reports.FabricatorPoAgingReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="wrapper row-offcanvas row-offcanvas-left">
        <div class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h2 style="text-align: center;">Fabricator's Job PO Aging Report</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                                                                            ...
                                                                            <ContentTemplate>
                                                                                ...
                                                                                <br />
                                                                                    ...
                                                                                    <Columns>
                                                                                      ...
                                                                                      NavigateUrl='<%# "~/PrintGeneratedFabricatorPOWithoutAmount.aspx?id="+ Eval("slno") %>' Target="_blank">
                                                                                                   </asp:HyperLink>
                                                                                            </DataItemTemplate>
                                                                                        </dx:GridViewDataTextColumn>--%>
                                                                                    </Columns>
