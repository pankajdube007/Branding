<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="JobTypeImageReport.aspx.cs" Inherits="GoldMedal.Branding.Admin.Transaction.Reports.JobTypeImageReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="wrapper row-offcanvas row-offcanvas-left">
        <div class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h2 style="text-align: center;">Job Type Image Report</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    ...
                    <asp:UpdatePanel runat="server">
                        <ContentTemplate>
                            ...
                            <dx:ASPxPageControl EnableHierarchyRecreation="False" ID="ASPxPageControl1" runat="server"
                                ...
                                <TabPages>
                                    <%--.Start of Tab-1--%>
                                    <dx:TabPage Text="Active Image List">
                                        <ContentCollection>
                                                                                   ...
                                                                                   EnableCallBacks="false"  >
                                                                                    <Columns>
                                                                                        ...
                                                                                        <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" FieldName="slno" Caption="slno" Visible="false" VisibleIndex="1">
                                                                                         ...
                                                                                         <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" FieldName="name" Caption="Job Type" VisibleIndex="2">
                                                                                            <Settings ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowInFilterControl="True" AutoFilterCondition="Contains" />
                                                                                        </dx:GridViewDataTextColumn>

                                                                                         <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" Caption="Job Type Photo" ReadOnly="True" VisibleIndex="3">
                                                                                            <Settings AllowDragDrop="True" />
                                                                                             <DataItemTemplate>

                                                                                                   <asp:LinkButton ID="lnkJobTypePhoto" EnableViewState="false" runat="server" OnClientClick="lp.Show()"
                                                                                                        CommandArgument='<%# Eval("slno") %>' Text='View File' 
                                                                                                        Style="text-decoration: underline;" OnCommand="lnkJobTypePhoto_Command"></asp:LinkButton>

                                                                                            </DataItemTemplate>
                                                                                        </dx:GridViewDataTextColumn>

                                                                                        <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" FieldName="ImageValidFromDate" Caption="Image Valid From Date" VisibleIndex="4">
                                                                                            <Settings ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowInFilterControl="True" AutoFilterCondition="Contains" />
                                                                                        </dx:GridViewDataTextColumn>

                                                                                         <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" FieldName="ImageValidToDate" Visible="false" Caption="Image Valid To Date" VisibleIndex="5">
                                                                                            <Settings ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowInFilterControl="True" AutoFilterCondition="Contains" />
                                                                                        </dx:GridViewDataTextColumn>
                                     ...
                                     <%--.Start of Tab-2--%>
                                    <dx:TabPage Text="Inactive Image List">
                                        <ContentCollection>
                                                                                         ...
                                                                                         <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" Caption="Job Type Photo" ReadOnly="True" VisibleIndex="3">
                                                                                            <Settings AllowDragDrop="True" />
                                                                                             <DataItemTemplate>
                                                                                                   ...
                                                                                                   <asp:LinkButton ID="lnkJobTypePhotoInactive" EnableViewState="false" runat="server" OnClientClick="lp.Show()"
                                                                                                        CommandArgument='<%# Eval("slno") %>' Text='View File' 
                                                                                                        Style="text-decoration: underline;" OnCommand="lnkJobTypePhotoInactive_Command"></asp:LinkButton>
