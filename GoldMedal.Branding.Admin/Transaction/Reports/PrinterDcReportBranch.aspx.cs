...
{
    public partial class PrinterDcReportBranch : System.Web.UI.Page
    {
        ...
        private DataTable GetTable1()
        {
            ...
            dt4 = objselectall.GetPrinterDCReportBranch(dsp);
            return dt4;
        }
        ...
        {
            return string.Format("PrinterDC_Report_Branch_{0}", DateTime.Now.ToString());
        }
