...
{
    public partial class FabricatorSupplierReport : System.Web.UI.Page
    {
        ...
        private DataTable GetTable1()
        {
            ...
            dt4 = objselectall.GetFabricatorSupplierReport(dsp);
            return dt4;
        }
        ...
        {
            return string.Format("Fabricator_Supplier_Report_{0}", DateTime.Now.ToString());
        }
