<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="Fabricator.aspx.cs" Inherits="GoldMedal.Branding.Admin.Master.Fabricator.Fabricator" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        <div class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h2 style="text-align: center;">Fabricator</h2>
                </div>
            </div>
                                                         ...
                                                         <div class="col-md-3">
                                                            ...
                                                            <div class="col-md-3">
                                                                ...
                                                                <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                                                                    <ContentTemplate>
                                                                        <asp:TextBox ID="txtmobno" ClientIDMode="Static" MaxLength="50" TextMode="Number"  onblur="return IsMobileNumber()" onkeypress="return noNumbers(event)" runat="server" TabIndex="4" CssClass="form-control"></asp:TextBox>
                                                                    </ContentTemplate>
                                                                </asp:UpdatePanel>
                                                            </div>
                                                            <div class="col-md-3">
                                                                ...
                                                                <asp:UpdatePanel ID="UpdatePanel9" runat="server">
                                                                    <ContentTemplate>
                                                                        <asp:TextBox ID="txtemail" ClientIDMode="Static" onblur="return validateEmail()" onkeypress="return noNumbers(event)" runat="server" TabIndex="5" CssClass="form-control"></asp:TextBox>
                                                                    </ContentTemplate>
                                                                </asp:UpdatePanel>
                                                            </div>
                                                            </div>
                                                                ...
                                                                <asp:UpdatePanel ID="UpdatePanel16" runat="server">
                                                                    <ContentTemplate>
                                                                        <div style="display:flex;">
                                                                            ...
                                                                            <div style="width:100%;">
                                                                                <asp:TextBox ID="txtUserName" ClientIDMode="Static" onblur="" onkeypress="return noNumbers(event)" runat="server" TabIndex="6" CssClass="form-control"></asp:TextBox>
                                                                            </div>
                                                                        </div>
                                                                    </ContentTemplate>
                                                                </asp:UpdatePanel>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <asp:UpdatePanel ID="UpdatePanel11" runat="server">
                                                                    <ContentTemplate>
                                                                        <asp:TextBox ID="txtrate" ClientIDMode="Static" Width="90px" Text="0.00" TextMode="Number"  runat="server" TabIndex="4" CssClass="form-control hei"></asp:TextBox>
                                                                    </ContentTemplate>
                                                                </asp:UpdatePanel>
                                                            </div>
                                                        </div>
                                                                            ...
                                                                            <ContentTemplate>
                                                                                ...
                                                                                <dx:ASPxGridView Settings-ShowGroupPanel="true" SettingsBehavior-AllowDragDrop="true"
                                                                                    ...
                                                                                    <Columns>
                                                                                        ...
                                                                                        <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" FieldName="name" Caption="Fabricator" VisibleIndex="1">
