<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="SubJobType.aspx.cs" Inherits="GoldMedal.Branding.Admin.Master.SubJobType.SubJobType" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script type="text/javascript">
        function Validation() {
            ...
            if (ProductType == "") {
                alert("Please enter subjob type");
                $("#txtName").focus();
                return false;
            }
            else {
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="wrapper row-offcanvas row-offcanvas-left">
        <div class="content" id="contactForm">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h2 style="text-align: center;">Sub Job Type
                    </h2>
                </div>
            </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <dx:ASPxButton ID="CmdSubmit" runat="server" OnClick="CmdSubmit_Click" AutoPostBack="False"
                                                                            ...
                                                                            <ClientSideEvents Click="function(s, e) {e.processOnServer= Validation(); }" />
                                                                        </dx:ASPxButton>
                                                                        ...
                                                                        <asp:UpdatePanel ID="UpdatePanel23" runat="server">
                                                                            ...
                                                                            <ContentTemplate>
                                                                                ...
                                                                                <dx:ASPxGridView Settings-ShowGroupPanel="true" SettingsBehavior-AllowDragDrop="true"
                                                                                    ...
                                                                                    <Columns>
                                                                                        <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" FieldName="Name" Caption="SubJob Type" VisibleIndex="1">
