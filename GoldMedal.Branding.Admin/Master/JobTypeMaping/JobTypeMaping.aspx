<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="JobTypeMaping.aspx.cs" Inherits="GoldMedal.Branding.Admin.Master.JobTypeMaping.JobTypeMaping" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="wrapper row-offcanvas row-offcanvas-left">
        <div class="content" id="contactForm">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h2 style="text-align: center;">Job and Sub Job Type Mapping
                    </h2>
                </div>
            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-2">
                                                                ...
                                                                <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                                                    <ContentTemplate>
                                                                        <dx:ASPxComboBox ID="cmbJobType" ClientInstanceName="cmbJobType" ClientIDMode="Static" runat="server" CssClass="form-control"
                                                            ...
                                                            <div class="col-md-2">
                                                                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                                                    <ContentTemplate>
                                                                        <dx:ASPxButton ID="btnBaseTemplatesSearchDelete" runat="server" AutoPostBack="false" Visible="false" Text="Delete" Width="80px">
                                                                        </dx:ASPxButton>
                                                                        <dx:ASPxButton ID="btnadd" runat="server" Text=">" CssClass="listin" Theme="Default" OnClick="btnadd_Click" Height="16px">
