<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PrinterPricingMaster.aspx.cs" Inherits="GoldMedal.Branding.Admin.Master.Printer.PrinterPricingMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        <div class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h2 style="text-align: center;">Printer Pricing Master</h2>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <asp:UpdatePanel ID="UpdatePanel24" runat="server">
                        <ContentTemplate>
                            ...
                            <asp:HiddenField ID="hfEPrinterID" ClientIDMode="Static" Value="0" runat="server"></asp:HiddenField>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-3">
                                                                ...
                                                                <label>Printer Quotation:</label>
                                                                <div class="form-group">
                                                                    <dx:ASPxComboBox ID="cmbPrinterQT" ClientInstanceName="cmbPrinterQT" ClientIDMode="Static" runat="server" CssClass="form-control"
                                                                        EnableIncrementalFiltering="True" TabIndex="1" TextField="PrinterQuotationNumber"
                                                                        ValueField="slno" TextFormatString="{0}-{1}"
                                                                        IsTextEditable="True" ValueType="System.String"
                                                                        IncrementalFilteringMode="Contains" OnSelectedIndexChanged="cmbPrinterQT_SelectedIndexChanged" AutoPostBack="True">
                                                                        <ClientSideEvents SelectedIndexChanged="function(s, e) { lp.Show(); ASPxCallback1.PerformCallback(); }" />
                                                                    </dx:ASPxComboBox>
                                                                </div>
                                                            ...
                                                            <div class="col-md-12">
                                                                <label style="margin-bottom: 10px;"><strong class="redmark">*Note - </strong>If material price is not added, Job can not be sent for printing.</label>
                                                            </div>
                                                                        ...
                                                                        <asp:UpdatePanel ID="UpdatePanel23" runat="server">
                                                                            ...
                                                                            <ContentTemplate>
                                                                                ...
                                                                                <dx:ASPxGridView Settings-ShowGroupPanel="true" SettingsBehavior-AllowDragDrop="true"
                                                                                    ...
                                                                                    <Columns>
                                                                                        <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" FieldName="Printer" Caption="Printer" VisibleIndex="1">
                        ...
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server" style="display: inline-block;">
                            <ContentTemplate>
                                <div class="row" style="margin-bottom:20px;">
                                    <div class="col-md-4">
                                        <label>Printer:</label>
                                        <asp:Label ID="lblPrinter" CssClass="" runat="server"></asp:Label>
                                    </div>
                                    <div class="col-md-8">
