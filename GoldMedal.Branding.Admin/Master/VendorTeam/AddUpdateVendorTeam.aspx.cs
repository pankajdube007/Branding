...
namespace GoldMedal.Branding.Admin.Master.VendorTeam
{
    public partial class AddUpdateVendorTeam : System.Web.UI.Page
    {
        ...
        private string TableNm = "tbl_VendorTeamUsers";
        ...
        {
            return string.Format("Master_VendorTeam_{0}", DateTime.Now.ToString());
        }
        /// <summary>
        ...
        private DataTable GetTable1()
        {
            ...
            dt4 = objselectall.GetVendorTeamUsers();
            return dt4;
        }
        ...
        protected void DataInsert()
        {
            ...
            Data.FinalAssembaly.FinalAssembly.VendorTeamInsert dst = new Data.FinalAssembaly.FinalAssembly.VendorTeamInsert();
            ...
            else
            {
                ...
                {
                    dst.usernm = "ven_" + username;
                }
                else
                {

                    if (!username.Contains("ven_"))
                    {
                        dst.usernm = "ven_" + username;
                    }
                    else
                ...
                result = objinsert.AddVendorTeam(dst);
                if (result == -2)
                {
        ...
        protected void CheckEditBlock(string param, int id)
        {
            ...
            if (param == "Delete")
            {
                ...
                Data.FinalAssembaly.FinalAssembly.VendorTeamDelete ddel = new Data.FinalAssembaly.FinalAssembly.VendorTeamDelete();
                ...
                rows = objdelete.VendorTeamUserDeleteMethod(ddel);
                if (rows == 1)
                {
            ...
            else
            {
                ...
                Data.FinalAssembaly.FinalAssembly.VendorTeamInsert dtsingle = new Data.FinalAssembaly.FinalAssembly.VendorTeamInsert();
                ...
                DataTable dt = objselectsingle.GetVendorTeamUserSingle(dtsingle);
                if (dt.Rows.Count > 0)
                {
                    if (dt.Rows.Count > 0)
                    {
