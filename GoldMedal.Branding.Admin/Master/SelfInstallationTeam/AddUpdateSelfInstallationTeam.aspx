<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="AddUpdateSelfInstallationTeam.aspx.cs" Inherits="GoldMedal.Branding.Admin.Master.SelfInstallationTeam.AddUpdateSelfInstallationTeam" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        <div class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h2 style="text-align: center;">Self Installation Team</h2>
                </div>
            </div>
