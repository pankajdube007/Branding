...
namespace GoldMedal.Branding.Admin.Master.SelfInstallationTeam
{
    public partial class AddUpdateSelfInstallationTeam : System.Web.UI.Page
    {
        ...
        private string TableNm = "tbl_SelfInstallationTeamUsers";
        ...
        {
            return string.Format("Master_SelfInstallationTeam_{0}", DateTime.Now.ToString());
        }
        /// <summary>
        ...
        private DataTable GetTable1()
        {
            ...
            dt4 = objselectall.GetSelfInstallationTeamUsers();
            return dt4;
        }
        ...
        protected void DataInsert()
        {
            ...
            Data.FinalAssembaly.FinalAssembly.SelfInstallationTeamInsert dst = new Data.FinalAssembaly.FinalAssembly.SelfInstallationTeamInsert();
            ...
            else
            {
                ...
                {
                    dst.usernm = "self_" + username;
                }
                else
                {

                    if (!username.Contains("self_"))
                    {
                        dst.usernm = "self_" + username;
                    }
                    else
                ...
                result = objinsert.AddSelfInstallationTeam(dst);
                if (result == -2)
                {
        ...
        protected void CheckEditBlock(string param, int id)
        {
            ...
            if (param == "Delete")
            {
                ...
                Data.FinalAssembaly.FinalAssembly.SelfInstallationTeamDelete ddel = new Data.FinalAssembaly.FinalAssembly.SelfInstallationTeamDelete();
                ...
                rows = objdelete.SelfInstallationTeamUserDeleteMethod(ddel);
                if (rows == 1)
                {
            ...
            else
            {
                ...
                Data.FinalAssembaly.FinalAssembly.SelfInstallationTeamInsert dtsingle = new Data.FinalAssembaly.FinalAssembly.SelfInstallationTeamInsert();
                ...
                DataTable dt = objselectsingle.GetSelfInstallationTeamUserSingle(dtsingle);
                if (dt.Rows.Count > 0)
                {
                    if (dt.Rows.Count > 0)
                    {
