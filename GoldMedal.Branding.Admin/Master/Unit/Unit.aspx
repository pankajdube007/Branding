<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="Unit.aspx.cs" Inherits="GoldMedal.Branding.Admin.Master.Unit.Unit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="wrapper row-offcanvas row-offcanvas-left">
        <div class="content" id="contactForm">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h2 style="text-align: center;">Unit
                    </h2>
                </div>
            </div>
                                                            ...
                                                            <ContentTemplate>
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <dx:ASPxButton ID="btnCancel" runat="server" Text="Clear" TabIndex="5" CssClass="btn btn-space"
                                                                        ...
                                                                        <asp:UpdatePanel ID="UpdatePanel23" runat="server">
                                                                            ...
                                                                            <ContentTemplate>
                                                                                ...
                                                                                <dx:ASPxGridView Settings-ShowGroupPanel="true" SettingsBehavior-AllowDragDrop="true"
                                                                                    ...
                                                                                    <Columns>
                                                                                        <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" FieldName="Name" Caption="Unit" VisibleIndex="1">
