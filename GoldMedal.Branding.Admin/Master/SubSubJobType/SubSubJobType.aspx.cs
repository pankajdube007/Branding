...
namespace GoldMedal.Branding.Admin.Master.SubSubJobType
{
    public partial class SubSubJobType : System.Web.UI.Page
    {
        ...
        private string TableNm = "Tbl_SUbSUbJobType";
        ...
        protected void btnOverWrite_Click(object sender, EventArgs e)
        {
            ...
            Data.SubSubJobType.SubSubJobTypeModel.SubSubJobTypeInsert dtsingle = new Data.SubSubJobType.SubSubJobTypeModel.SubSubJobTypeInsert();
            ...
            DataTable dt = objselectsingle.GetSubSubJobTypeSingle(dtsingle);
            if (dt.Rows.Count > 0)
            {
        ...
        protected void DataInsert()
        {
            ...
            Data.SubSubJobType.SubSubJobTypeModel.SubSubJobTypeInsert dst = new Data.SubSubJobType.SubSubJobTypeModel.SubSubJobTypeInsert();
            ...
            else
            {
                ...
                if (lbslno.Text == "0")
                {
                    Core.SubSubJobType.SubSubJobType objinsert = new Core.SubSubJobType.SubSubJobType();
                    result = objinsert.SubSubJobTypeInsertMethod(dst);
                    if (result == 2)
                    {
        ...
        /// <summary>
        /// returns the datatable which contains the all SubSub Jo type records
        /// </summary>
        /// <returns></returns>
        private DataTable GetTable1()
        {
            ...
            dt4 = objselectall.GetSubSubJobTypeAll();
            return dt4;
        }
            ...
            if (dtEditChk.Rows.Count > 0)
            {
                if (dtEditChk.Rows[0]["PStatus"] != null && (dtEditChk.Rows[0]["PStatus"].ToString() == "InActive" || dtEditChk.Rows[0]["PStatus"].ToString() == "Unchecked"))
                {
                    if (param == "Delete")
                    {
                        ...
                        Data.SubSubJobType.SubSubJobTypeModel.SubSubJobTypeDelete ddel = new Data.SubSubJobType.SubSubJobTypeModel.SubSubJobTypeDelete();
                        ...
                        Core.SubSubJobType.SubSubJobType objdelete = new Core.SubSubJobType.SubSubJobType();
                        rows = objdelete.SubSubJobTypeDeleteMethod(ddel);
                        if (rows == 1)
                        {
        ...
        {
            return string.Format("Master_Material_{0}", DateTime.Now.ToString());
        }
