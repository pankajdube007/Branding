<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeBehind="RegionalLang.aspx.cs" Inherits="GoldMedal.Branding.Admin.Master.RegionalLang.RegionalLang" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="wrapper row-offcanvas row-offcanvas-left">
        <div class="content" id="contactForm">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h2 style="text-align: center;">Regional Language
                    </h2>
                </div>
            </div>
                                                    ...
                                                    <div class="col-md-12" style="height: 400PX">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-2">
                                                                ...
                                                                <label>Job Type:<strong class="redmark">*</strong></label>
                                                                <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                                                    <ContentTemplate>
                                                                        ...
                                                                        <dx:ASPxComboBox ID="cmbJobType" OnSelectedIndexChanged ="cmbJobType_SelectedIndexChanged" AutoPostBack="true"
                                                                             ClientInstanceName="cmbJobType" ClientIDMode="Static" runat="server" CssClass="form-control"
                                                            ...
                                                            <div class="col-md-2">
                                                                ...
                                                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                                    <ContentTemplate>
                                                                        <dx:ASPxComboBox ID="cmbSubJobType"  ClientInstanceName="cmbSubJobType"   AutoPostBack="true" ClientIDMode="Static" runat="server" CssClass="form-control"
                                                                            EnableIncrementalFiltering="True" TabIndex="1" TextField="subjobname"
                                                                            ValueField="subjobtypeid" TextFormatString="{0}-{1}"
                                                                            IsTextEditable="True" ValueType="System.String"
                                                                            IncrementalFilteringMode="Contains">
                                                                        </dx:ASPxComboBox>
                                                                    </ContentTemplate>
                                                                        ...
                                                                        <asp:UpdatePanel ID="UpdatePanel23" runat="server">
                                                                            ...
                                                                            <ContentTemplate>
                                                                                ...
                                                                                <dx:ASPxGridView Settings-ShowGroupPanel="true" SettingsBehavior-AllowDragDrop="true"
                                                                                    ...
                                                                                    <Columns>
                                                                                        <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" FieldName="JobType" Caption="JobType" VisibleIndex="1">
                                                                                            <Settings ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowInFilterControl="True"
                                                                                                AutoFilterCondition="Contains" />
                                                                                        </dx:GridViewDataTextColumn>
                                                                                        <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" FieldName="SubJobType" Caption="SubJobType" VisibleIndex="2">
                                                                                            <Settings ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowInFilterControl="True"
                                                                                                AutoFilterCondition="Contains" />
                                                                                        </dx:GridViewDataTextColumn>
                                                                                        <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" FieldName="Branch" Caption="Branch" VisibleIndex="3">
                                                                                            <Settings ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowInFilterControl="True"
                                                                                                AutoFilterCondition="Contains" />
                                                                                        </dx:GridViewDataTextColumn>
                                                                                         <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" FieldName="isactive" Caption="IsActive" VisibleIndex="4">
                                                                                            <Settings ShowFilterRowMenu="True" ShowFilterRowMenuLikeItem="True" ShowInFilterControl="True"
                                                                                                AutoFilterCondition="Contains" />
                                                                                        </dx:GridViewDataTextColumn>
