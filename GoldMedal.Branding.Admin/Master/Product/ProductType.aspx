<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="ProductType.aspx.cs" Inherits="GoldMedal.Branding.Admin.Master.ProductType" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="wrapper row-offcanvas row-offcanvas-left">
        <div class="content" id="contactForm">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h2 style="text-align: center;">Product Type</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                                                                        ...
                                                                        <asp:UpdatePanel ID="UpdatePanel23" runat="server">
                                                                            ...
                                                                            <ContentTemplate>
                                                                                ...
                                                                                <dx:ASPxGridView Settings-ShowGroupPanel="true" SettingsBehavior-AllowDragDrop="true"
                                                                                    ...
                                                                                    <Columns>
                                                                                        <dx:GridViewDataTextColumn Settings-AllowDragDrop="True" FieldName="Name" Caption="Product Type" VisibleIndex="1">
